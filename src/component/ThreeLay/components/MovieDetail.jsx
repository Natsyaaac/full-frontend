      ...
      <div className="detail-content">
        ...
        <div className="detail-grid">
          ...
          <div className="detail-item">
            ...
            <span className="detail-value rating-highlight">★ {movie.rating}</span>
          </div>
          ...
          <div className="detail-item">
            ...
            <span className={`detail-value status-badge
              ...
              // classname{...} memnetukan css dinamis tambah status warched (jika ditonton) atau tambahkan status-unwatched (jika tidak ditonton)
            }
            >
              {movie.watched ? 'Watched' : 'Not Watched'
                // teks dinamis sama dengan class diatas dia akan mengikuti boolead jika true (watched) jika false (not watched)
              }
            </span>
          </div>
        </div>
